...
ggplot(kids_and_pop) +
  ...
  labs(x="year", y="rate of foster children per 10,000 in Vermont", title="In Vermont, the number of foster children per 10,000 in Vermont fell between 2006 and 2010", subtitle = "After 2010, the number of foster children began to rise", caption = "Source: Census data") +
...
# now lets make another chart! this time i am thinkin a line graph 
