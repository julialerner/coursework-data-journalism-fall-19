...
```{r}
# how many pills per person were sent to vermont in this time frame? 
```

```{r}

# I am just so lost and feeling very frustrated. 

#how many pills went to vermont in 2006? 
VT_pills_2006 <- arcos_county_pills_per_year %>%
  filter(buyer_state == "VT", year == "2006") %>%
